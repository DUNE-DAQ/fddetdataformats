...
register_wib2(py::module& m)
{
  ...
  py::class_<WIB2Frame>(m, "WIB2Frame", py::buffer_protocol())
    ...
    .def("get_bytes",
         [](WIB2Frame* fr) -> py::bytes { return py::bytes(reinterpret_cast<char*>(fr), sizeof(WIB2Frame)); });
  ...
  py::class_<WIB2Frame::Header>(m, "WIB2Header")
    ...
    .def_property_readonly("colddata_timestamp_id",
                           [](WIB2Frame::Header& self) -> uint32_t { return self.colddata_timestamp_id; })
    ...
    .def_property_readonly("lock_output_status",
                           [](WIB2Frame::Header& self) -> uint32_t { return self.lock_output_status; })
    .def_property_readonly("femb_pulser_frame_bits",
                           [](WIB2Frame::Header& self) -> uint32_t { return self.femb_pulser_frame_bits; })
    .def_property_readonly("femb_sync_flags", [](WIB2Frame::Header& self) -> uint32_t { return self.femb_sync_flags; })
    .def_property_readonly("colddata_timestamp",
                           [](WIB2Frame::Header& self) -> uint32_t { return self.colddata_timestamp; });
