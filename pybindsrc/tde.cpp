...
register_tde(py::module& m)
{
  ...
  py::class_<TDE16Frame>(m, "TDE16Frame", py::buffer_protocol())
    ...
    .def(
      "get_daq_header",
      [](TDE16Frame& self) -> detdataformats::DAQEthHeader* { return self.get_daq_header(); },
      py::return_value_policy::reference_internal)
    .def(
      "get_tde_header",
      [](TDE16Frame& self) -> TDEHeader* { return self.get_tde_header(); },
      py::return_value_policy::reference_internal)
    .def("get_adc_sample", &TDE16Frame::get_adc_sample)
    .def_static("sizeof", []() { return sizeof(TDE16Frame); })
    .def("get_bytes",
         [](TDE16Frame* fr) -> py::bytes { return py::bytes(reinterpret_cast<char*>(fr), sizeof(TDE16Frame)); });
