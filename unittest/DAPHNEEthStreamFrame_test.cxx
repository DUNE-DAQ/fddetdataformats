...
#define BOOST_TEST_MODULE DAPHNEEthStreamFrame_test
...
BOOST_AUTO_TEST_CASE(DAPHNEEthStreamFrame_IndexAndValueBounds)
{
  ...
  BOOST_CHECK_THROW(frame.set_adc(0, 0, static_cast<uint16_t>(1 << DAPHNEEthStreamFrame::s_bits_per_adc)), std::out_of_range);
...
BOOST_AUTO_TEST_CASE(DAPHNEEthStreamFrame_BitPackingBoundaryIsolation)
{
  ...
  DAPHNEEthStreamFrame frame{};
  constexpr uint16_t max_adc = static_cast<uint16_t>((1u << DAPHNEEthStreamFrame::s_bits_per_adc) - 1u);
